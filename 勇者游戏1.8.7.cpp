...
char name[21]; 
int attack;
int defense; //勇者游戏1.8.7版本更新 
int health;//更新日志：增加三个玩家角色！包括皮厚力大的大力士、自带弹药的投弹手、可以迷晕怪物（大部分）的美女！ 
long int max_health;//修改女巫为巫师（为了美女的技能） 
...
int miss;
int nex; 
}strongman={"森林巨人","黄金圣衣",50,60,350,200,100,1,2,5,2,1},
witch={"森林巫师","银甲",40,30,100,50,50,2,2,0,1,1},
xiyi={"森林蜥蜴","铁甲",30,25,50,30,35,3,3,0,0,1},
big_strongman={"森林巨人王","巨人之臂",150,180,1200,800,400,4,4,10,3,1},
lions={"草原狮群","雄狮之爪",120,150,1800,800,400,13,4,10,3,1},
lion={"草原雄狮","绝世好剑",70,40,280,200,100,5,2,5,2,1},
horse={"草原野马","碧血剑",50,30,90,50,50,6,2,0,1,1}, 
bee={"草原黄蜂","长剑",30,20,60,30,35,7,3,0,0,1},
stone={"山脉岩石","布衣",10,40,100,50,20,0,4,0,0,0},
asshole={"山脉菊花","匕首",30,10,60,50,20,8,4,0,0,0},
shitu={"大学渣","\0",350,170,1600,1200,600,-1,0,15,3,1},
wugui={"巨龟","神龟之盾",100,500,500,1000,400,11,3,10,2,1},
shark={"巨兽鲨","狂鲨利齿",350,50,500,1000,400,10,3,10,3,1},
fish={"食人鱼","进入下一关的钥匙",35,25,70,40,40,9,8,0,0,1},
pangxie={"螃蟹","进入下一关的钥匙",30,35,70,40,40,9,8,0,0,1},
smallshark={"小鲨","进入下一关的钥匙",45,35,100,50,50,12,7,0,1,1},
lanjing={"小蓝鲸","进入下一关的钥匙",30,50,200,50,50,12,7,0,1,1},
oldman={"校长","\0",570,270,2700,1800,1000,-1,0,20,4,1}, 
...
int max_exp=0;
int choose_number=0,s=0,strongman_arm=0,lion_hand=0,battle=0,money=1000,place_sign=11,bi=0,buy_number=0,yun=0,yaoshi1=0,yaoshi2=0;
int cao=4,jijiubao=3,baiyao=3,superbaiyao=1,boom=4,dubiao=3,atom_boom=1,aircase=1,diangun=1,yulei=1,zidan=1,s1=0,res,number=0;
...
{
printf("物品: 1,止血草%d个 2,急救包%d个 3,云南白药%d个 4,超级云南白药%d个 5,手雷%d个 6,毒标%d个 7,手抛式原子弹%d个 8,逼能激光炮 9,氧气袋%d个 10,电棍%d个 11,鱼雷%d个 12,狙击枪 0,返回\n\n\n",cao,jijiubao,baiyao,superbaiyao,boom,dubiao,atom_boom,aircase,diangun,yulei);
