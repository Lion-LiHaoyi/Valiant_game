...
char name[21]; 
int attack;
int defense; //勇者游戏1.5.1版本更新 
int health;//更新日志：把陈曦忽略的我做的1.4.0版本部分内容加上，优化显示速度及内容 
long int max_health;// 进一步优化参数 
...
wugui={"巨龟","神龟之盾",100,500,500,150,100,11,1,1,0},
shark={"巨兽鲨","狂鲨利齿",350,50,500,300,150,10,1,1,0},
...
int cao=4,jijiubao=3,baiyao=3,superbaiyao=1,boom=4,dubiao=3,atom_boom=1,bi_boom=0;
...
if(strongman_arm)
{
SlowDisplay("神秘校长:\n\n\n 哈哈,年轻人,做的不错,不过...嘿嘿,你上当啦!巨人之臂我要了,校花你也别想带走!\n\n\n");
guai=shitu;
printf("%s扑了过来!\n\n\n",guai.name);
BattleAct();
}
else SlowDisplay("神秘校长:\n\n\n 年轻人,你好啊.如果你有巨人之臂,我可以告诉你校花的下落哦~\n\n\n");
}
break;
