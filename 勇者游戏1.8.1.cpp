...
char name[21]; 
int attack;
int defense; //勇者游戏1.8.1版本更新 
int health;//更新日志：新增中级可视化（窗口式选择，感谢学长15A28qiuruicen的代码琢磨出来的），对颜色问题进行了修复。 
long int max_health;//把被浪费的参数guai.double_attack用了上来，怪物攻击可能翻倍（我把可能降得很低了不用担心） 
...
float double_attack;
int miss;
}strongman={"森林巨人","黄金圣衣",50,60,350,200,100,1,2,0.5,2},
witch={"森林女巫","银甲",40,30,100,50,50,2,2,0,1},
xiyi={"森林蜥蜴","铁甲",30,25,50,30,35,3,3,0,0},
big_strongman={"森林巨人王","巨人之臂",150,180,1200,800,400,4,4,1,3},
lions={"草原狮群","雄狮之爪",120,150,1800,800,400,13,4,1,3},
lion={"草原雄狮","绝世好剑",70,40,280,200,100,5,2,0.5,2},
...
int cao=4,jijiubao=3,baiyao=3,superbaiyao=1,boom=4,dubiao=3,atom_boom=1,aircase=1,diangun=1,yulei=1,zidan=1,s1=0,res,res1;
...
break;
case 0: 
res1=MessageBox(NULL,"确定退出游戏？","提示",MB_YESNO);
if(res1==IDYES)
{
