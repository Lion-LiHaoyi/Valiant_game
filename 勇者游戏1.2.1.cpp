...
char name[21]; 
int attack;
int defense; //原作：16届ZHOUKAI 改编：17届CHENXI（跪求授权合作）2次改编：17届lihaoyi （跪求授权合作）2.1次改编：17届lihaoyi （跪求授权合作）
int health; //此版本修改：山脉岩石和菊花bug修复，吴桐学长系统修改， 黄沙漫天bug修复 
long int max_health; //购买性价比提高，显示错误修复 
int level; 
int exp; 
int range_exp; 
long int max_exp; 
...
stone={"山脉岩石","布衣",1,50,100,50,20,11,3,2,2},
asshole={"山脉菊花","匕首",20,10,60,50,20,10,3,2,2},
shitu={"使徒","\0",65*7,35*7,285*7,205*7,105*7,9,1,1,0},
...
int max_exp=0;
int choose_number=0,s=0,strongman_arm=0,battle=0,money=1000,place_sign=9,buy_number=0;
int cao=6,jijiubao=5,baiyao=3,superbaiyao=1,boom=5,dubiao=3,atom_boom=1;
...
case 1: //显示移动菜单
SlowDisplay("要去哪里?\n\n\n");
printf("1,酒吧 2,旅馆 3,山脉 4,森林一层 5,森林二层 6,森林三层 7,草原一层 8,草原二层 9,草原三层 10,马勒戈壁\n\n\n");
switch(scanf("%d",&choose_number),choose_number)
{
...
break;
case 3:
printf("要喝点什么?\n\n\n 1,二锅头20金币 HP+30 2,XO酒50金币 HP+100 3,人头马面100金币 HP+150 0,返回\n\n\n");
choose_number=1;
while(choose_number)
{
switch(scanf("%d",&choose_number),choose_number)
