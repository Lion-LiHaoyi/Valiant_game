...
char name[21]; 
int attack;
int defense; //勇者游戏1.7.0版本更新 
int health;//增加海洋一层二层，新增怪食人鱼、螃蟹、小鲨、小蓝鲸 
long int max_health;// 增加初级可视化（高级陈曦负责）增加道具水下步枪 ，海洋三地图进阶式进入 
...
stone={"山脉岩石","布衣",10,40,100,50,20,0,4,2,2},
asshole={"山脉菊花","匕首",30,10,60,50,20,8,4,2,2},
shitu={"大学渣","...什么都没有...",350,170,1600,1200,600,-1,1,1,0},
...
smallshark={"小鲨","进入下一关的钥匙",45,35,100,50,50,12,7,1,0},
lanjing={"小蓝鲸","进入下一关的钥匙",30,50,200,50,50,12,7,1,0},
oldman={"校长","...什么都没有...",570,270,2700,1800,1000,-1,1,1,0}, 
...
int max_exp=0;
int choose_number=0,s=0,strongman_arm=0,battle=0,money=1000,place_sign=11,bi=0,buy_number=0,yun=0,yaoshi1=0,yaoshi2=0;
